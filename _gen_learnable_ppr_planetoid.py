"""Generates learnable_ppr_planetoid.ipynb — Learnable PPR on Cora/CiteSeer/PubMed."""
import json
...
md("## 4. Phase 1 Diagnostic Dashboard")
...
md("### 5a. Build / load subgraph caches (one-time cost)")
...
# ── 8. Cross-Encoder Comparison ───────────────────────────────────────────────
md("## 8. Cross-Method Comparison")
...
# ── 9. Per-Edge Config by Degree ──────────────────────────────────────────────
md("## 9. Per-Edge Config by Node Degree")
...
# ═══════════════════════════════════════════════════════════════════════════════
with open(r"d:\Work + Project\Thesis\MTCH\learnable_ppr_planetoid.ipynb", "w", encoding="utf-8") as f:
    json.dump(nb, f, indent=1)
print("Notebook written: learnable_ppr_planetoid.ipynb")
