"""
OPTIMIZED training pipeline for PPR-based subgraph link prediction.
...
def train_epoch_ppr_batched(encoder, predictor, data, split_edge, ppr_extractor,
    ...
    for perm in dataloader:
        ...
        for idx, i in enumerate(perm):
            ...
            # Get precomputed PPR scores (O(1) lookup!)
...
def train_model_ppr_batched(encoder, predictor, data, split_edge, ppr_extractor,
    ...
    for epoch in iterator:
        ...
        loss = train_epoch_ppr_batched(encoder, predictor, data, split_edge, ppr_extractor,
